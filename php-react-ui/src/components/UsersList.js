...
class UsersList extends Component{
    ...
    fetchUsers = () => {
        fetch('http://localhost/php-react/php-react-api/all-users.php')
        .then(response => {
    ...
    handleUpdate = (id) => {
        Axios.post('http://localhost/php-react/php-react-api/update-user.php',
        {
            id:id,
    ...
    handleDelete = (id) => {
        ...
        Axios.post('http://localhost/php-react/php-react-api/delete-user.php',{
            id:id
        })
        .then(({data}) => {
            if(data.success === 1){
